...
<template>
  <div class="max-w-[1200px] mx-auto pb-28 space-y-8 px-4 sm:px-6    ">
    ...
    <header class="relative py-8">
      <div class="absolute -top-10 -left-10 w-64 h-64 bg-primary/10 blur-[100px] rounded-full -z-10 animate-pulse" />
      <div class="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
          <div class="flex items-center gap-3 mb-3">
            <div class="w-10 h-10 rounded-2xl bg-primary/10 border border-primary/20 flex items-center justify-center shadow-inner">
              <span class="material-symbols-outlined text-primary text-2xl">piano</span>
            </div>
            <p class="text-[10px] font-black text-primary uppercase tracking-[0.25em]">Professional Profile</p>
          </div>
    ...
    <div v-if="activeTab === 'my-instruments'" class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
      ...
      <section class="lg:col-span-8 space-y-6">
        <div class="flex items-center justify-between px-2">
          ...
          <span class="text-xs font-bold text-on-surface-variant bg-on-surface/5 dark:bg-on-surface/5 px-3 py-1 rounded-full border border-on-surface/5 dark:border-on-surface/5 uppercase tracking-widest">
          ...
          >
            ...
            <div class="flex justify-between items-start relative z-10">
              <div class="flex items-center gap-4">
                <div class="w-12 h-12 rounded-2xl bg-primary flex items-center justify-center shadow-lg text-on-primary">
              ...
              <button 
                class="w-8 h-8 rounded-xl bg-rose-500/10 text-rose-500 border border-rose-500/10 opacity-0 group-hover:opacity-100 transition-all hover:bg-rose-500 hover:text-on-surface flex items-center justify-center"
        ...
        <div class="glass-medium rounded-[2rem] border border-outline-variant/30 p-6 space-y-6 shadow-xl">
          ...
          <div class="relative group">
            ...
            <input 
              ...
              class="w-full pl-12 pr-4 py-3 bg-surface-container-highest/20 border border-outline-variant/30 rounded-2xl text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary/40 transition-all"
            />
          </div>
          ...
          <div class="space-y-2 max-h-[400px] overflow-y-auto pr-2 custom-scrollbar">
            ...
            >
              ...
              <button 
                class="w-8 h-8 rounded-xl bg-primary/10 text-primary border border-primary/10 hover:bg-primary hover:text-on-surface flex items-center justify-center transition-all disabled:opacity-30"
    ...
    <div v-else class="space-y-6">
      <div v-if="shopStore.myOrders.length > 0" class="grid gap-4">
        <div
          ...
          :key="order.id"
          class="glass-heavy rounded-[2rem] p-6 border border-outline-variant/20 dark:border-on-surface/5 hover:border-primary/30 transition-all group"
        >
