...
<template>
  <div class="w-full mx-auto pb-10">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        >
          <div class="h-2 bg-primary w-full relative">
            <div class="absolute right-2 -top-1 w-3 h-3 bg-surface-container-lowest rounded-full animate-ping"></div>
            <div class="absolute right-2 -top-1 w-3 h-3 bg-surface-container-lowest rounded-full"></div>
          </div>
          <div class="p-5 flex-1 flex flex-col justify-center">
            <p
              class="text-[10px] font-black text-primary uppercase tracking-widest mb-1 flex items-center gap-2"
            >
              LIVE NOW
            </p>
        ...
        <div
          v-else
          class="liquid-glass border border-on-surface/[0.04] dark:border-on-surface/5 rounded-3xl p-5 flex flex-col justify-center items-center text-center opacity-70"
        >
        ...
        <div
          v-if="nextSession"
          class="liquid-glass border border-on-surface/[0.04] dark:border-on-surface/5 border-l-[6px] border-l-outline-variant dark:border-l-on-surface/20 rounded-3xl p-5 cursor-pointer hover:bg-on-surface/5 dark:hover:bg-on-surface/5 transition-all flex flex-col justify-center group"
        ...
        <div
          v-else
          class="liquid-glass border border-on-surface/[0.04] dark:border-on-surface/5 border-l-[6px] border-l-outline-variant dark:border-l-on-surface/10 rounded-3xl p-5 flex flex-col justify-center items-center text-center opacity-70"
        >
        ...
        <div class="liquid-glass rounded-3xl p-4 border border-on-surface/[0.04] dark:border-on-surface/5 space-y-3">
          ...
          <div v-else class="grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            <div
              ...
              :key="entry.studentId"
              class="bg-on-surface/[0.04] dark:bg-on-surface/5 border border-on-surface/[0.04] dark:border-on-surface/5 p-5 rounded-3xl flex items-center gap-4 hover:border-primary/40 transition-all group cursor-pointer"
              @click="openRosterSession(entry.studentId)"
            >
              <div
                class="w-16 h-16 rounded-2xl overflow-hidden shadow-2xl border border-on-surface/[0.08] dark:border-on-surface/10 group-hover:scale-105 transition-transform bg-surface-container-highest flex items-center justify-center shrink-0"
              >
              ...
              <div class="flex-1 min-w-0">
                ...
                <div class="flex gap-2 flex-wrap">
                  <span
                    class="px-2.5 py-1 bg-primary/10 text-primary text-[9px] font-bold rounded-full border border-primary/20 uppercase"
                    >{{ entry.status }}</span
                  >
                </div>
              </div>
            ...
            <!-- Enroll New -->
            <div
              class="bg-on-surface/[0.04] dark:bg-on-surface/5 p-5 rounded-3xl flex items-center justify-center border-2 border-dashed border-on-surface/[0.08] dark:border-on-surface/10 hover:border-primary/50 hover:bg-on-surface/[0.06] dark:hover:bg-on-surface/[0.08] transition-all group cursor-pointer"
            >
                  ...
                  day.session.status === 'scheduled'
                    ...
                    : day.session.status === 'pending_admin'
                      ...
                      : day.session.status === 'pending_teacher'
                        ...
                        : 'bg-on-surface/5 dark:bg-on-surface/5 border-on-surface/10 dark:border-on-surface/20'
                "
                @click="day.session && openSessionModal(day.session)"
              >
                <p class="text-[10px] font-black text-primary mb-1">
    ...
    <section class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8">
      ...
      >
        <div
          class="w-20 h-20 rounded-3xl bg-primary text-on-surface flex items-center justify-center text-4xl font-black shadow-2xl group-hover:scale-110 transition-transform"
        >
          {{ mySessions.length }}
        </div>
        <div>
      ...
      >
        <div
          class="w-20 h-20 rounded-3xl bg-primary/20 text-primary flex items-center justify-center shadow-inner group-hover:scale-110 transition-transform"
        >
        ...
        >
          ...
          <div v-if="expandedSession.status === 'pending_teacher'" class="p-4 bg-primary/5 border border-primary/20 rounded-3xl space-y-3">
             <div class="flex items-center gap-2 mb-2">
                ...
                <span class="text-xs font-bold text-primary uppercase tracking-wider">Student Proposal</span>
             </div>
          ...
          <div class="space-y-3">
            ...
            <textarea
              ...
              class="w-full h-32 bg-on-surface/[0.04] dark:bg-on-surface/5 border border-on-surface/[0.06] dark:border-on-surface/5 rounded-3xl focus:ring-2 focus:ring-primary/40 text-sm p-5 text-on-surface dark:text-on-surface placeholder:text-on-surface-variant resize-none transition-all"
          ...
          <div class="flex gap-3 pt-2">
            ...
            <button
              class="flex-1 py-3 rounded-xl bg-primary hover:scale-[1.02] text-on-primary text-sm font-black transition-all active:scale-95 shadow-lg"
        ...
        <div class="relative w-full max-w-sm liquid-glass border border-on-surface/10 rounded-3xl p-6 space-y-4 shadow-2xl">
          ...
          <div class="space-y-4">
            ...
            <div class="flex gap-3">
               ...
               <button class="px-5 py-3 bg-on-surface/5 text-on-surface-variant font-bold rounded-2xl text-sm" @click="showCounterModal = false">Cancel</button>
            </div>
          </div>
        </div>
      </div>
