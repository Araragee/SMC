...
<template>
  <div class="page">
    ...
    <!-- Ledger Table -->
    <section class="glass-heavy rounded-3xl border border-outline-variant/30 overflow-hidden shadow-2xl shadow-black/5 dark:shadow-black/20">
    ...
    <!-- Monthly Breakdown -->
    <section v-if="monthlyBreakdown.length > 0" class="glass-heavy rounded-3xl border border-outline-variant/30 overflow-hidden shadow-2xl shadow-black/5 dark:shadow-black/20">
