      ...
      <div class="col-span-1 md:col-span-8 space-y-4">
        ...
        <section class="liquid-glass rounded-3xl p-4 border border-on-surface/[0.04] dark:border-on-surface/5">
          ...
          >
            ...
            <button
              class="mt-4 px-4 py-2 bg-primary text-on-primary rounded-2xl font-bold text-sm transition-all hover:scale-[1.02] active:scale-95"
              @click="openRequestModal"
            >
              Request a Session
            </button>
          ...
          <div v-else class="space-y-4">
            <div
              ...
              :key="session.id"
              class="bg-on-surface/[0.04] dark:bg-on-surface/5 border border-on-surface/[0.04] dark:border-on-surface/5 p-4 rounded-3xl flex items-center gap-6 hover:bg-on-surface/5 dark:hover:bg-on-surface/10 hover:translate-x-1 transition-all cursor-pointer group"
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            >
              <template v-if="!proofPreviewUrl">
                <div
                  class="size-14 bg-primary/10 text-primary rounded-full flex items-center justify-center mb-4 group-hover:scale-110 transition-transform"
                >
                  <span
        ...
        <section class="liquid-glass rounded-3xl p-4 border border-on-surface/[0.04] dark:border-on-surface/5">
          ...
          <div class="space-y-4">
            ...
            >
              <div class="relative z-10">
                <span
                  class="inline-block px-2 py-1 bg-on-surface/20 rounded-lg text-xs font-semibold uppercase mb-3"
                  >Limited Offer</span
                >
                ...
                <button
                  class="bg-surface-container-lowest text-primary px-4 py-2 rounded-2xl text-xs font-semibold uppercase hover:scale-105 active:scale-95 transition-all"
                >
                  Learn More
                </button>
              </div>
        ...
        >
          ...
          >
            ...
            <div v-else-if="stagedProofUrl" class="flex flex-col gap-3">
              ...
              <button
                class="w-full py-2 bg-primary hover:scale-[1.02] text-on-primary text-xs font-semibold rounded-lg transition-all active:scale-95"
          ...
          <form class="space-y-4" @submit.prevent="submitRequest">
            ...
            <div class="flex gap-3 pt-2">
              ...
              <button
                ...
                class="flex-1 py-3 rounded-xl bg-primary hover:scale-[1.02] text-on-primary text-sm font-semibold transition-all active:scale-95 disabled:opacity-50"
              >
