            ...
            <div class="relative z-10 flex flex-col h-full">
              ...
              <div class="mt-auto pt-6 flex items-center gap-4">
                ...
                >
                  ...
                  />
                  <div class="w-full py-4 bg-indigo-500 text-on-surface rounded-2xl text-[10px] font-black uppercase tracking-widest flex items-center justify-center gap-2 shadow-lg shadow-indigo-500/20 hover:scale-[1.02] active:scale-95 transition-all">
