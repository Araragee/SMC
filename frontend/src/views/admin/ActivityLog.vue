    ...
    <header class="pt-8">
      ...
      <div class="flex items-end justify-between gap-4 flex-wrap">
        ...
        <div class="flex items-center gap-2">
          <button
            class="flex items-center gap-2 px-5 py-3 glass-medium border border-outline-variant/30 hover:bg-on-surface/5 dark:hover:bg-on-surface/5 rounded-2xl font-black text-sm text-on-surface transition-all"
      ...
      <div v-if="totalCount > PAGE_SIZE" class="flex items-center justify-between mt-6 gap-3 flex-wrap">
        ...
        <div class="flex items-center gap-2">
          <button
            ...
            @click="currentPage--"
            class="w-9 h-9 rounded-2xl glass-medium border border-outline-variant/30 flex items-center justify-center text-on-surface transition-all hover:bg-on-surface/5 dark:hover:bg-on-surface/5 disabled:opacity-30 disabled:cursor-not-allowed"
          >
          ...
          <template v-for="p in totalPages" :key="p">
            <button
              ...
              :class="p === currentPage
                ? 'bg-violet-500 text-on-surface border-violet-500 shadow-lg shadow-violet-500/20'
