    ...
    <section class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
      ...
      >
        ...
        <div class="relative z-10">
          <span class="text-[10px] font-black text-on-surface/70 uppercase tracking-[0.2em]"
            >Retention Rate</span
          >
          <div
            v-if="scheduleStore.isLoading"
          ...
          />
          <h2 v-else class="text-5xl font-black mt-2 tracking-tighter text-on-surface">
      ...
      >
        ...
        <div class="flex -space-x-3 mt-6">
          ...
          <div
            ...
            class="w-10 h-10 rounded-full border-2 border-surface-container-highest bg-primary text-on-primary text-[10px] font-black flex items-center justify-center"
          >
            +{{ students.length - 3 }}
          </div>
        </div>
          ...
          <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4">
            ...
            <div class="flex items-center gap-3">
              ...
              <button
                ...
                class="px-5 py-2.5 bg-on-surface/[0.04] dark:bg-on-surface/5 text-on-surface-variant dark:text-on-surface-variant text-[10px] font-black uppercase tracking-widest border border-on-surface/[0.08] dark:border-on-surface/10 rounded-2xl hover:bg-on-surface/5 dark:hover:bg-on-surface/10 transition-colors flex items-center gap-2"
              ...
              <RouterLink
                ...
                class="px-5 py-2.5 bg-primary text-on-primary text-[10px] font-black uppercase tracking-widest rounded-2xl hover:opacity-90 transition-opacity flex items-center gap-2 shadow-lg"
              >
              ...
              <tbody class="divide-y divide-on-surface/[0.04] dark:divide-on-surface/5">
                ...
                >
                  <td class="py-6 px-2">
                    <div class="flex items-center gap-4">
                      <div
                        class="w-12 h-12 rounded-[18px] bg-surface-container-highest border border-on-surface/[0.08] dark:border-on-surface/10 flex items-center justify-center text-on-surface dark:text-on-surface font-black text-lg"
                      >
      ...
      <div class="space-y-4">
        ...
        >
          <div class="flex items-center justify-between mb-8">
            ...
            <div class="flex items-center gap-2">
              <span
                ...
                class="text-[10px] font-black text-primary bg-primary/10 px-3 py-1 rounded-full border border-primary/20 flex items-center gap-1"
              >
          ...
          <div class="space-y-4 max-h-[400px] overflow-y-auto p-1.5 custom-scrollbar">
            ...
            >
              <div class="flex gap-4">
                ...
                <div>
                  <h4
                    class="text-[10px] font-black uppercase tracking-[0.2em] mb-1 text-primary"
                  >
                    Schedule Alert
                  </h4>
          ...
          <RouterLink
            ...
            class="flex items-center justify-center gap-2 w-full mt-8 py-4 text-[10px] font-black text-on-surface-variant dark:text-on-surface-variant bg-on-surface/[0.04] dark:bg-on-surface/5 border border-on-surface/[0.08] dark:border-on-surface/10 rounded-3xl hover:bg-on-surface/5 dark:hover:bg-on-surface/10 hover:text-on-surface dark:hover:text-on-surface transition-all uppercase tracking-[0.2em]"
          >
        ...
        >
          <div
            class="absolute -top-10 -right-10 w-40 h-40 bg-on-surface/[0.06] dark:bg-on-surface/10 rounded-full blur-3xl"
          ></div>
          <div class="relative z-10">
            ...
            <div class="space-y-5">
              <div>
                <label
                  class="text-[10px] font-black uppercase tracking-[0.2em] text-on-surface/60 block mb-2"
                  >Teacher</label
                >
                <select
                  v-model="quickTeacherId"
                  class="w-full bg-on-surface/20 rounded-2xl px-5 py-3 text-xs font-bold border border-on-surface/20 focus:outline-none focus:ring-1 focus:ring-on-surface/40 hover:bg-on-surface/30 transition-all appearance-none cursor-pointer text-on-surface"
                >
              ...
              <div class="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    v-model="quickDate"
                    type="date"
                    class="w-full bg-on-surface/20 rounded-2xl px-5 py-3 text-xs font-bold border border-on-surface/20 focus:outline-none focus:ring-1 focus:ring-on-surface/40 hover:bg-on-surface/30 transition-all cursor-pointer text-on-surface [color-scheme:dark]"
                  />
                </div>
                <div>
                  <label
              ...
              <button
                ...
                class="w-full bg-on-surface/30 border border-on-surface/20 text-on-surface font-black py-4 rounded-3xl shadow-lg mt-4 active:scale-95 transition-all uppercase text-[10px] tracking-[0.2em] disabled:opacity-50 disabled:cursor-not-allowed"
