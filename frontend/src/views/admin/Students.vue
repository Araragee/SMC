...
const allStudents = computed(() => {
  ...
  switch (sortBy.value) {
    ...
    case 'sessions-high': out.sort((a, b) => (b.sessionsLeft ?? 0) - (a.sessionsLeft ?? 0)); break
    case 'sessions-low':  out.sort((a, b) => (a.sessionsLeft ?? 0) - (b.sessionsLeft ?? 0)); break
  }
  return out
})
...
<template>
  <div class="max-w-[1600px] mx-auto pb-28 space-y-6 px-4 sm:px-6">
    ...
    <!-- Header -->
    <div>
      <h1 class="text-5xl font-black tracking-tight text-on-surface mb-2">Students</h1>
        ...
        >
          ...
          <div class="flex items-center gap-2 shrink-0">
            ...
            <span
              ...
              :class="(student.sessionsLeft ?? 0) === 0
            ...
            <div class="overflow-y-auto flex-1 p-6 space-y-5 custom-scrollbar">
              ...
              <div class="grid grid-cols-2 gap-3">
                ...
                <div class="bg-teal-500/10 border border-teal-500/20 rounded-2xl p-3">
                  <p class="text-[9px] font-black text-teal-400 uppercase tracking-widest mb-1">Sessions Left</p>
                  <p class="text-2xl font-black text-teal-400">{{ selectedStudent.sessionsLeft ?? 0 }}</p>
                </div>
              </div>
