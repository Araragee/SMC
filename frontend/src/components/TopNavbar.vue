  ...
  >
    ...
    <div class="flex items-center gap-3 px-2">
      ...
      <div class="hidden sm:block leading-none">
        <h2 class="text-white font-black tracking-tight text-sm">Sernan's</h2>
    ...
    <button
      ...
      class="relative w-11 h-11 rounded-full flex items-center justify-center text-zinc-400 hover:text-white hover:bg-white/5 transition-all group"
      title="Notifications"
    >
      <span class="material-symbols-outlined text-2xl group-hover:scale-110 transition-transform">notifications</span>
      <span
        v-if="unreadCount > 0"
        class="absolute top-1.5 right-1.5 w-5 h-5 bg-orange-500 rounded-full text-[10px] font-black text-white flex items-center justify-center border-2 border-[#121212]"
    ...
    <div class="relative">
      <button
        ...
        class="flex items-center gap-3 px-4 py-2 rounded-full hover:bg-white/5 transition-all group border border-transparent"
      ...
      >
        ...
        <div class="hidden lg:block text-left">
          <p class="text-sm font-bold text-white leading-tight truncate max-w-[120px]">{{ authStore.currentUser?.name || 'User' }}</p>
