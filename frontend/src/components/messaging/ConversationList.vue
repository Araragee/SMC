...
<template>
  <div class="flex flex-col h-full">
    ...
    <div class="px-4 py-3 border-b border-on-surface/[0.04] dark:border-on-surface/5">
      <button
        class="w-full flex items-center justify-center gap-2 py-2.5 bg-primary/10 hover:bg-primary/20 border border-primary/20 rounded-2xl text-primary text-xs font-black uppercase tracking-widest transition-colors"
        @click="showNew = true"
      >
    ...
    <div class="flex-1 overflow-y-auto">
      ...
      >
        ...
        <span
          ...
          class="min-w-[18px] h-[18px] bg-primary rounded-full text-[10px] font-black text-on-surface flex items-center justify-center px-1 shrink-0"
        >
