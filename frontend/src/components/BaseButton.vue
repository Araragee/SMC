...
const computedClasses = computed(() => {
  const baseClasses = 'group relative font-bold font-headline uppercase tracking-wider overflow-hidden active:scale-[0.98] transition-all duration-300 rounded-xl';
